        ...
        <div>
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-lg sm:text-xl font-bold tracking-tight text-white font-sans">
              Planned Gatherings & Circles
            </h1>
          </div>
          <p className="text-xs text-zinc-400 mt-0.5">
            Upcoming social sessions and activity circles with encrypted attendee groups
          </p>
        </div>

        <button
          onClick={() => setIsHostModalOpen(true)}
          className="min-h-[38px] flex items-center gap-1.5 px-3.5 py-1.5 text-xs font-semibold text-black bg-amber-400 hover:bg-amber-300 rounded-xl transition-colors shadow-sm self-start sm:self-auto cursor-pointer"
        >
            ...
            >
              <div>
                ...
                <div className="flex items-center justify-between gap-2">
                  <div className="flex items-center gap-1.5 text-xs text-amber-400 bg-amber-950/30 px-2.5 py-1 rounded-lg border border-amber-800/40">
                ...
                <div className="flex items-center gap-2 mt-1.5 text-xs text-zinc-400">
                  <div className="w-5 h-5 rounded-full bg-zinc-800 text-[10px] flex items-center justify-center text-amber-300 font-medium">
                ...
                {/* Venue & Location */}
                <div className="mt-3 pt-2.5 border-t border-zinc-800/80 space-y-1 text-xs">
                ...
                <div className="mt-2.5 p-2 rounded-xl bg-zinc-900 border border-zinc-800 text-[11px] text-zinc-400 flex items-start gap-2">
              ...
              {/* Action Buttons */}
              <div className="mt-4 pt-3 border-t border-zinc-800/80 flex items-center justify-between gap-2.5">
                {/* RSVP Toggle Button */}
                <button
                  onClick={() => onToggleRsvp(gathering.id)}
                  className={`min-h-[38px] flex items-center gap-1.5 px-3.5 py-1.5 text-xs font-semibold rounded-xl transition-colors cursor-pointer ${
                ...
                <button
                  ...
                  className="min-h-[38px] flex items-center gap-1.5 px-3.5 py-1.5 text-xs font-semibold text-black bg-amber-400 hover:bg-amber-300 rounded-xl transition-colors cursor-pointer"
                >
